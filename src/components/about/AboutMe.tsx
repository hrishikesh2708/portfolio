...
const AboutMe = () => {
  return (
    <div className="py-10 lg:max-h-[1300px] w-full mt-30">
      <div className="flex flex-col items-center justify-center lg:flex-row gap-2 lg:gap-40 ">
        <div className="px-3 py-4 max-w-lg">
          ...
          <div className="text-center text-balance lg:text-pretty lg:text-left font-light text-base text-black/80 md:tracking-wider dark:text-neutral-300 flex flex-col gap-4">
            <p>
              Hi, I'm Hrishikesh Thakur — a curious software engineer passionate
              about building meaningful digital experiences. I work across the
              full stack, creating efficient web applications while also
              exploring the world of data through machine learning, NLP, and
              data analysis. I love turning complex problems into clean,
